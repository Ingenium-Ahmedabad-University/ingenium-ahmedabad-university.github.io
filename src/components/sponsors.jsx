...
const data = [
        ...
        list: [
            {
                ...
                logoUrl: "https://githubuniverse.com/assets/img/sponsors/Sauce-Labs_Vert_White_RGB.svg",
                name: "Google",
                description: "Search Engine",
            },
            {
                redirectUrl: "https://www.google.com/search?client=firefox-b-d&q=google",
                logoUrl: "https://githubuniverse.com/assets/img/sponsors/Contrast_Security%20Logo%20(white).svg",
                name: "Google",
                description: "Search Engine",
            },
            {
                redirectUrl: "https://www.google.com/search?client=firefox-b-d&q=google",
                logoUrl: "https://githubuniverse.com/assets/img/sponsors/Snyk-white%20(1).png",
                name: "Google",
                description: "Search Engine",
            },{
                redirectUrl: "https://www.google.com/search?client=firefox-b-d&q=google",
    ...
    },
    {
        ...
        list: [
            {
                redirectUrl: "https://www.google.com/search?client=firefox-b-d&q=google",
                logoUrl: "https://githubuniverse.com/assets/img/sponsors/SonarSource%20-%20blanc.svg",
                name: "Google",
                description: "Search Engine",
            },
            {
                redirectUrl: "https://www.google.com/search?client=firefox-b-d&q=google",
                logoUrl: "https://githubuniverse.com/assets/img/sponsors/Codame_Badge_Logo_08_white.png",
                name: "Google",
                description: "Search Engine",
            },
            {
                redirectUrl: "https://www.google.com/search?client=firefox-b-d&q=google",
                logoUrl: "https://githubuniverse.com/assets/img/sponsors/Datree_Logo_1_color%20(1).png",
                name: "Google",
                description: "Search Engine",
            },
            {
            ...
            { data.map( (category, i) => {
                return(
                    <div key={ i } className="mb-24">
                        <h1 className="text-primary text-3xl sm:text-4xl">{ category.name }</h1>
