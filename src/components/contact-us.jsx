...
const ImgTemplate = ({
  ...
  return (
    <div className=''>
      ...
      >
        <div className=''>
          <div class='text-center text-white font-bold text-lg'>{name}</div>
          <br />
          <div
            class={
              hoverRef
    ...
    <code class='font-sans'>
      <div class='grid grid-cols-1 relative lg:grid-cols-3 gap-5'>
        <div class='grid grid-cols-1 relative'>
          <div class='hidden lg:grid object-cover bg-gradient-to-br from-red-500 to-indigo-400 social-bg fixed left-0 top-36 space-y-3 px-10 xl:px-20'>
            <div class='text-4xl font-bold py-5'>
              <h1 class=''>MEET THE TEAM</h1>
            </div>

            <div class='font-bold cursor-pointer'>
              <a href='#1'>CORE TEAM</a>
            </div>

            <div class='font-bold cursor-pointer'>
              <a href='#2'>EVENT TEAM</a>
            </div>

            <div class='font-bold cursor-pointer'>
              <a href='#3'>SPONSORS TEAM</a>
            </div>

            <div class='font-bold cursor-pointer'>
              <a href='#4'>MARKETING TEAM</a>
            </div>

            <div class='font-bold cursor-pointer'>
              <a href='#5'>LOGISTICS TEAM</a>
            </div>

            <div class='font-bold cursor-pointer'>
              <a href='#6'>CONTENT TEAM</a>
            </div>
          </div>
        </div>
