...
const Card = ({ redirectUrl, logoUrl, name, description }) => (
  <div class='w-full max-w-sm mx-auto hover:border-primary sponsors-cards'>
    <a href={redirectUrl}>
      <div className='flex justify-center items-center bg-blur-light w-full h-32 max-h-32'>
