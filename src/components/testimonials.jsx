...
const testimonials_data = [
  {
    review:
      'Quis do sint aute officia laborum est adipisicing do dolore. Ad ullamco Lorem aliquip reprehenderit non culpa magna et. Ut et nulla Lorem consectetur quis nostrud voluptate cupidatat quis do elit culpa.',
    ...
    <section class='text-gray-400 body-font'>
      ...
      >
        <div class='xl:w-1/2 lg:w-3/4 w-full mx-auto text-center'>
          ...
          <p class='leading-relaxed text-lg h-40'>{data[selected].review}</p>
          <span class='inline-block h-1 w-10 rounded bg-indigo-500 mt-8 mb-2'></span>
          <h2 class='text-white font-medium mb-1 title-font tracking-wider text-sm'>
            {data[selected].name}
          </h2>
