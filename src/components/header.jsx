  ...
  return (
    <>
      <div className='desktop-nav'>
        <div className='pr-6 pt-6 flex gap-4'>
        {options.map((e) => (
          <div className='text-white text-2xl font-bold navText'>
            <Link to={`/${e.link}`}>
              {e.name}
            </Link>
          </div>
      ...
      <div
        className=' h-24 w-24 grid place-items-center cursor-pointer mobile-nav'
        onClick={() => {
...
const Header = () => (
  <>
  <div className='navbar-back flex z-10 justify-between'>
    <Logo />
    <NavIcon />
  </div>
  </>
...
//   return (
//     <>
//       <div className='fixed top-0 right-0 desktop-nav'>
//         <div className='pr-6 pt-6 flex gap-4'>
//         {options.map((e) => (
//           <div className='text-white text-lg font-bold navText'>
//             <Link to={`/${e.link}`}>
//               {e.name}
//             </Link>
//           </div>
...
//       <div
//         className='fixed top-0 right-0 z-50 h-24 w-24 grid place-items-center cursor-pointer mobile-nav'
//         onClick={() => {
//           console.log('state change');
//           change_nav(!nav_open);
//         }}
