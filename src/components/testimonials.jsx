...
const testimonials_data = [
  {
    review:"Quis do sint aute officia laborum est adipisicing do dolore. Ad ullamco Lorem aliquip reprehenderit non culpa magna et. Ut et nulla Lorem consectetur quis nostrud voluptate cupidatat quis do elit culpa.",
    ...
    <section class='text-gray-400 body-font'>
      <div class='container px-5 pt-24 pb-8 mx-auto'>
        <div class='xl:w-1/2 lg:w-3/4 w-full mx-auto text-center'>
          ...
          <p class='leading-relaxed text-lg min-h-24'>{data[selected].review}</p>
      ...
      <div className='grid grid-flow-col justify-center gap-3'>
        {data.map((e, i) => (
          <Profile
            url={e.image}
            selected={i === selected}
            onClick={() => {changeselected(i); clearTimeout(tout)}}
          />
        ))}
      </div>
    </section>
