...
const icon1 =
  'https://cdn.jsdelivr.net/npm/simple-icons@v4/icons/instagram.svg';
...
const ImgTemplate = ({
  ...
  return (
    <div className='grid grid-row-2'>
      ...
      >
        <div
          class='place-items-center px-5 text-black mx-auto bg-center bg-cover h-48 w-40 md:mx-8 lg:w-64 h-64'
              ...
              <div class=''>
                ...
                <div class='grid grid-cols-3 justify-center align-middle px-6 gap-3 place-items-center lg:px-10'>
                  <a href={instagram_Url}>
                    <img src={icon1} height='24' width='24' />
                  </a>
                  <a href={facebook_Url}>
                    <img src={icon2} height='24' width='24' />
                  </a>
                  <a href={linkedLn_Url}>
                    <img src={icon3} height='24' width='24' />
                  </a>
                </div>
              </div>
            )}
